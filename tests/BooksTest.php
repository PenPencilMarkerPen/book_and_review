...
class BooksTest extends ApiTestCase {
    ...
    public function testUpdateBook():void
    {
        ...
        $iri = $this->findIriBy(Book::class, ['isbn' => '9781782164104']);
    ...
    {
        BookFactory::createOne(['isbn' => '9781782164105']);
        $client = static::createClient();
        $iri = $this->findIriBy(Book::class, ['isbn' => '9781782164105']);
        $client->request('DELETE', $iri);
        $this->assertResponseStatusCodeSame(204);
        $this->assertNull(
            static::getContainer()->get('doctrine')->getRepository(Book::class)->findOneBy(['isbn' => '9781782164105'])
        );
    }
